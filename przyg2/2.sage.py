...
_sage_const_5 = Integer(5); _sage_const_11 = Integer(11); _sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_256 = Integer(256)# Mateusz Karpiński
# WCY23KY1S1
...
n = random.randint(_sage_const_5 ,_sage_const_11 )
...
for i in range(_sage_const_1 , t+_sage_const_1 ):
    ...
    if x_k == x_k_saved:
        ...
        Rand = random.randint(_sage_const_1 ,_sage_const_256 )
