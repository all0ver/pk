...
_sage_const_2 = Integer(2); _sage_const_16 = Integer(16); _sage_const_32 = Integer(32); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0)# Mateusz Karpiński
# WCY23KY1S1
...
x = randint(_sage_const_2 , q-_sage_const_1 )
y = power_mod(g, x, p)
...
k = random.randint(_sage_const_2 , q-_sage_const_1 )
R = power_mod(g, k, p)
...
if gcd(R, q) != _sage_const_1 :
    ...
    while True:
        ...
        a = randint(_sage_const_0 , q - _sage_const_1 )
        b = randint(_sage_const_1 , q - _sage_const_1 )  
        print("a =", a)
        print("b =", b)
        ...
        if _sage_const_1  <= m1 <= q - _sage_const_1 :
    ...
    oldy = y
    while x == oldx:
        x = random.randint(_sage_const_2 , q-_sage_const_1 )
    y = g**x
    print("Nowy wygenerowany zly klucz publiczny: y1 = ", y)
    print("Prawdziwy kluczy publiczny: y = ", y)
