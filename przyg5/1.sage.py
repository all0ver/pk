...
_sage_const_30 = Integer(30); _sage_const_32 = Integer(32); _sage_const_4 = Integer(4); _sage_const_3 = Integer(3); _sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0)# Mateusz Karpiński 
# WCY23KY1S1
...
q = q+_sage_const_1 
while (q%_sage_const_4 ) == _sage_const_3 :
    q = random.randint(_sage_const_2 , q-_sage_const_1 )
print("p = ", p)
print("q = ", q)
...
x0 = pow(x, _sage_const_2 , n)+_sage_const_1 
x1 = pow(x0, _sage_const_2 , n)
print("x0 = ", x0)
print("x1 = ", x1)
